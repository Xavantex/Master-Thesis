...
%   \item \textbf{Rule 6}, use xrange instead of range.
    ...
    %kanske måste kolla igenom tense för nedanstående.
...
NumPy's any function was able to be cut out using \texttt{try} and \texttt{except} statements, skipping the \texttt{if} statements all together.%%Good thing to have in theory.
