...
%Förklara de olika labels på varje rad?
...
The 200 time speedup does not account for any difference in hardware used for the measurements.
The results indicate that the VCPUs on the cluster perform worse individually compared to the CPU in the test PC.
In other words if the original MATLAB code was executed on one of the VCPUs, the speedup compared to those results would potentially have been greater than 200 times.
